...
contemplam todas as categorias, mas por algum motivo, os fornecedores dos produtos cuja categoria é a executiva, não estão no relatório.
...
SELECT name, 
       (SELECT name 
        FROM providers 
        WHERE id = products.id_providers) AS provider_name
FROM products 
